...
function apt_InstallPackages() {
    sudo apt install ssl-cert nginx mysql-server php-fpm php-curl php-dom php-mbstring php-xml php-zip php-imagick php-gd php-mysql php-bcmath php-dev libsodium-dev php-libsodium python-smbus i2c-tools pmount -y
}
